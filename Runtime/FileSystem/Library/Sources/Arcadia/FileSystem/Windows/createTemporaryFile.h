...
#if !defined(ARCADIA_FILESYSTEM_WINDOWS_CREATETEMPORARYFILE_H_INCLUDED)
#define ARCADIA_FILESYSTEM_WINDOWS_CREATETEMPORARYFILE_H_INCLUDED
...
#endif // ARCADIA_FILESYSTEM_WINDOWS_CREATETEMPORARYFILE_H_INCLUDED
