...
constructImpl
  (
    ...
    Arcadia_MILC_Backend_ClassSymbolInfo* self
  );
...
initializeDispatchImpl
  (
    Arcadia_Thread* thread,
    Arcadia_MILC_Backend_ClassSymbolInfoDispatch* self
  );
...
static void
Arcadia_MILC_Backend_ClassSymbolInfo_dumpImpl
  (
    Arcadia_Thread* thread,
    Arcadia_MILC_Backend_ClassSymbolInfo* self,
...
Arcadia_MILC_Backend_ClassSymbolInfo_getSymbolImpl
  (
    Arcadia_Thread* thread,
    Arcadia_MILC_Backend_ClassSymbolInfo* self
  );
...
Arcadia_MILC_Backend_ClassSymbolInfo_getCxxNameImpl
  (
    Arcadia_Thread* thread,
    Arcadia_MILC_Backend_ClassSymbolInfo* self
  );
...
static Arcadia_String*
Arcadia_MILC_Backend_ClassSymbolInfo_getCxxNameUpperCaseImpl
  (
    Arcadia_Thread* thread,
    Arcadia_MILC_Backend_ClassSymbolInfo* self
  );
...
Arcadia_MILC_Backend_ClassSymbolInfo_getCxxHeaderFilePathImpl
  (
    Arcadia_Thread* thread,
    Arcadia_MILC_Backend_ClassSymbolInfo* self
  );
...
static Arcadia_FilePath*
Arcadia_MILC_Backend_ClassSymbolInfo_getCxxHeaderFileAbsolutePathImpl
  (
    Arcadia_Thread* thread,
    Arcadia_MILC_Backend_ClassSymbolInfo* self
  );
...
static Arcadia_FilePath*
Arcadia_MILC_Backend_ClassSymbolInfo_getCxxSourceFilePathImpl
  (
    Arcadia_Thread* thread,
    Arcadia_MILC_Backend_ClassSymbolInfo* self
  );
...
static Arcadia_FilePath*
Arcadia_MILC_Backend_ClassSymbolInfo_getCxxSourceFileAbsolutePathImpl
  (
    Arcadia_Thread* thread,
    Arcadia_MILC_Backend_ClassSymbolInfo* self
  );
...
Arcadia_defineObjectType(u8"Arcadia.MILC.Backend.ClassSymbolInfo", Arcadia_MILC_Backend_ClassSymbolInfo,
...
{
  Arcadia_EnterConstructor(Arcadia_MILC_Backend_ClassSymbolInfo);
  ...
  Arcadia_LeaveConstructor(Arcadia_MILC_Backend_ClassSymbolInfo);
}
...
{
  ((Arcadia_MILC_Backend_SymbolInfoDispatch*)self)->dump = (void (*)(Arcadia_Thread*, Arcadia_MILC_Backend_SymbolInfo*, Arcadia_SizeValue, Arcadia_StringBuilder*))&Arcadia_MILC_Backend_ClassSymbolInfo_dumpImpl;
  ((Arcadia_MILC_Backend_SymbolInfoDispatch*)self)->getSymbol = (Arcadia_MILC_Symbol* (*)(Arcadia_Thread*, Arcadia_MILC_Backend_SymbolInfo*)) & Arcadia_MILC_Backend_ClassSymbolInfo_getSymbolImpl;
  ((Arcadia_MILC_Backend_SymbolInfoDispatch*)self)->getCxxName = (Arcadia_String* (*)(Arcadia_Thread*, Arcadia_MILC_Backend_SymbolInfo*))&Arcadia_MILC_Backend_ClassSymbolInfo_getCxxNameImpl;
  ((Arcadia_MILC_Backend_SymbolInfoDispatch*)self)->getCxxNameUpperCase = (Arcadia_String* (*)(Arcadia_Thread*, Arcadia_MILC_Backend_SymbolInfo*))&Arcadia_MILC_Backend_ClassSymbolInfo_getCxxNameUpperCaseImpl;

  ((Arcadia_MILC_Backend_SymbolInfoDispatch*)self)->getCxxHeaderFilePath = (Arcadia_FilePath * (*)(Arcadia_Thread*, Arcadia_MILC_Backend_SymbolInfo*)) & Arcadia_MILC_Backend_ClassSymbolInfo_getCxxHeaderFilePathImpl;
  ((Arcadia_MILC_Backend_SymbolInfoDispatch*)self)->getCxxHeaderFileAbsolutePath = (Arcadia_FilePath * (*)(Arcadia_Thread*, Arcadia_MILC_Backend_SymbolInfo*)) & Arcadia_MILC_Backend_ClassSymbolInfo_getCxxHeaderFileAbsolutePathImpl;
  ((Arcadia_MILC_Backend_SymbolInfoDispatch*)self)->getCxxSourceFilePath = (Arcadia_FilePath * (*)(Arcadia_Thread*, Arcadia_MILC_Backend_SymbolInfo*)) & Arcadia_MILC_Backend_ClassSymbolInfo_getCxxSourceFilePathImpl;
  ((Arcadia_MILC_Backend_SymbolInfoDispatch*)self)->getCxxSourceFileAbsolutePath = (Arcadia_FilePath * (*)(Arcadia_Thread*, Arcadia_MILC_Backend_SymbolInfo*)) & Arcadia_MILC_Backend_ClassSymbolInfo_getCxxSourceFileAbsolutePathImpl;
}
...
{ 
  Arcadia_MILC_Backend_ModuleSymbolInfo* module = (Arcadia_MILC_Backend_ModuleSymbolInfo*)Arcadia_MILC_Backend_SymbolInfo_getModule(thread, (Arcadia_MILC_Backend_SymbolInfo*)self);
  if (module == module) { }
...
{ return self->cxxHeaderFileAbsolutePath ? Arcadia_FilePath_clone(thread, self->cxxSourceFileAbsolutePath) : NULL; }

Arcadia_MILC_Backend_ClassSymbolInfo*
Arcadia_MILC_Backend_ClassSymbolInfo_create
  (
    Arcadia_Thread* thread,
...
{
  _Arcadia_BeginCreate(Arcadia_MILC_Backend_ClassSymbolInfo);
  ...
  Arcadia_ValueStack_pushNatural8Value(thread, 2);
  _Arcadia_EndCreate(Arcadia_MILC_Backend_ClassSymbolInfo); 
}
