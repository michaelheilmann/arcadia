...
constructImpl
  (
    ...
    Arcadia_MILC_Diagnostics_SymbolIsAlreadyDefinedDiagnostic* self
  );
...
initializeDispatchImpl
  (
    Arcadia_Thread* thread,
    Arcadia_MILC_Diagnostics_SymbolIsAlreadyDefinedDiagnosticDispatch* self
  );
...
Arcadia_defineObjectType(u8"Arcadia.MILC.Diagnostics.SymbolIsAlreadyDefinedDiagnostic", Arcadia_MILC_Diagnostics_SymbolIsAlreadyDefinedDiagnostic,
...
{
  Arcadia_EnterConstructor(Arcadia_MILC_Diagnostics_SymbolIsAlreadyDefinedDiagnostic);
  ...
  Arcadia_LeaveConstructor(Arcadia_MILC_Diagnostics_SymbolIsAlreadyDefinedDiagnostic);
}
...
{ 
  _Arcadia_BeginCreate(Arcadia_MILC_Diagnostics_SymbolIsAlreadyDefinedDiagnostic);
  ...
  _Arcadia_EndCreate(Arcadia_MILC_Diagnostics_SymbolIsAlreadyDefinedDiagnostic);
}
