  ...
  )
{
  ...
  {
    Arcadia_Value diagnosticType = Arcadia_ValueStack_getValue(thread, 5);
    Arcadia_Value file = Arcadia_ValueStack_getValue(thread, 4);
    Arcadia_Value offset = Arcadia_ValueStack_getValue(thread, 3);
