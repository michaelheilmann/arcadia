...
static void
Arcadia_Media_DSP_Gain_constructImpl
  (
    Arcadia_Thread* thread,
    Arcadia_Media_DSP_Gain* self
  );
...
static void
Arcadia_Media_DSP_Gain_initializeDispatchImpl
  (
    Arcadia_Thread* thread,
    Arcadia_Media_DSP_GainDispatch* self
  );

static void
Arcadia_Media_DSP_Gain_visitImpl
  (
    Arcadia_Thread* thread,
    Arcadia_Media_DSP_Gain* self
  );
...
static const Arcadia_ObjectType_Operations _objectTypeOperations = {
  ...
  .construct = (Arcadia_Object_ConstructCallbackFunction*)&Arcadia_Media_DSP_Gain_constructImpl,
  .visit = (Arcadia_Object_VisitCallbackFunction*)&Arcadia_Media_DSP_Gain_visitImpl,
  .initializeDispatch = (Arcadia_ObjectDispatch_InitializeCallbackFunction*)&Arcadia_Media_DSP_Gain_initializeDispatchImpl,
};
...
Arcadia_defineObjectType(u8"Arcadia.Media.DSP.Gain", Arcadia_Media_DSP_Gain,
...
{
  Arcadia_EnterConstructor(Arcadia_Media_DSP_Gain);
  {
  ...
  self->gain = Arcadia_ValueStack_getReal32Value(thread, 1);
  Arcadia_LeaveConstructor(Arcadia_Media_DSP_Gain);
}
...
{
  ((Arcadia_Media_DSPDispatch*)self)->render = (void (*)(Arcadia_Thread*, Arcadia_Media_DSP*, Arcadia_Media_DSP_Buffer*)) & Arcadia_Media_DSP_Gain_render;
  ((Arcadia_Media_DSPDispatch*)self)->reset = (void (*)(Arcadia_Thread*, Arcadia_Media_DSP*)) & Arcadia_Media_DSP_Gain_reset;
  ((Arcadia_Media_DSPDispatch*)self)->reseed = (void (*)(Arcadia_Thread*, Arcadia_Media_DSP*, Arcadia_Natural32Value)) & Arcadia_Media_DSP_Gain_reseed;
  ...
  )
{
  ...
  if (Arcadia_JumpTarget_save(&jumpTarget)) {
    ...
    for (Arcadia_SizeValue i = 0, n = numberOfSamples; i < n; ++i) {
      outputSamples[i] = inputSamples[i] * self->gain;
    }
  ...
  )
{
  ...
  _Arcadia_BeginCreate(Arcadia_Media_DSP_Gain);
  Arcadia_ValueStack_pushObjectReferenceValue(thread, (Arcadia_Object*)input);
  Arcadia_ValueStack_pushReal32Value(thread, gain);
  Arcadia_ValueStack_pushNatural8Value(thread, 2);
  _Arcadia_EndCreate(Arcadia_Media_DSP_Gain);
}
