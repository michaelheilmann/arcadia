...
{
  {
    ...
    Arcadia_Engine_ApplicationConfiguration_setInteger32(thread, configuration, path, 2, horizontalResolution);
  }
  {
    char const* path[] = {
      u8"visuals",
    ...
    Arcadia_Engine_ApplicationConfiguration_setInteger32(thread, configuration, path, 2, verticalResolution);
  }
  {
    char const* path[] = {
      u8"visuals",
    ...
    Arcadia_Engine_ApplicationConfiguration_setInteger32(thread, configuration, path, 2, colorDepth);
  }
}
  ...
  )
{
  Arcadia_Integer32Value temporary[3];
  {
    ...
    temporary[0] = Arcadia_Engine_ApplicationConfiguration_getInteger32(thread, configuration, path, 2);
  }
  {
    char const* path[] = {
      u8"visuals",
    ...
    temporary[1] = Arcadia_Engine_ApplicationConfiguration_getInteger32(thread, configuration, path, 2);
  }
  {
    char const* path[] = {
      u8"visuals",
    ...
    temporary[2] = Arcadia_Engine_ApplicationConfiguration_getInteger32(thread, configuration, path, 2);
  }
  ...
  )
{
  ...
  Arcadia_Engine_ApplicationConfiguration_setBoolean(thread, configuration, path, 2, value);
}
  ...
  )
{
  ...
  return Arcadia_Engine_ApplicationConfiguration_getBoolean(thread, configuration, path, 2);
}
...
void
Arcadia_Engine_ApplicationHelper_startupVisuals
  (
    Arcadia_Thread* thread,
  ...
  )
{
  ...
  // (2) Select visuals system.
  {
    ...
    if (Arcadia_JumpTarget_save(&jumpTarget)) {
      Arcadia_String* backendTypeName = Arcadia_Engine_ApplicationConfiguration_getString(thread, (Arcadia_DDL_Node*)configuration, path, 2);
      ...
      Arcadia_Engine_ApplicationConfiguration_setString(thread, (Arcadia_DDL_Node*)configuration, path, 2, backendTypeName);
      Arcadia_Value backendTypeValue = Arcadia_HashSet_findFirst(thread, (Arcadia_HashSet*)engine->visualsBackendTypes, Arcadia_Value_makeObjectReferenceValue(backendTypeName), &findTypeByName);
      if (!Arcadia_Value_isTypeValue(&backendTypeValue)) {
        Arcadia_Thread_setStatus(thread, Arcadia_Status_NotFound);
        Arcadia_Thread_jump(thread);
  ...
  // (3) Select display device (aka "monitor").
  {
    ...
    Arcadia_Thread_pushJumpTarget(thread, &jumpTarget);
    if (Arcadia_JumpTarget_save(&jumpTarget)) {
      displayDeviceIndex = Arcadia_Engine_ApplicationConfiguration_getInteger32(thread, (Arcadia_DDL_Node*)configuration, path, 2);
      ...
      Arcadia_Thread_popJumpTarget(thread);
      Arcadia_Engine_ApplicationConfiguration_setInteger32(thread, (Arcadia_DDL_Node*)configuration, path, 2, displayDeviceIndex);
    }
  ...
  // (4) Get the window mode.
  {
    ...
    Arcadia_Thread_pushJumpTarget(thread, &jumpTarget);
    if (Arcadia_JumpTarget_save(&jumpTarget)) {
      windowMode = Arcadia_Engine_ApplicationConfiguration_getString(thread, (Arcadia_DDL_Node*)configuration, path, 2);
      ...
      Arcadia_Engine_ApplicationConfiguration_setString(thread, (Arcadia_DDL_Node*)configuration, path, 2, windowMode);
    }
  }
