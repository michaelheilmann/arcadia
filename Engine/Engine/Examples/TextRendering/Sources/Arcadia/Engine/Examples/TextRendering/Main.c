...
#include "Arcadia/Engine/Examples/TextRendering/Application.h"

// The demo's scene, the initial scene of the game.
  ...
  )
{
  ...
  if (Arcadia_JumpTarget_save(&jumpTarget)) {
    ...
    Arcadia_Engine_Demo_SceneManager_setScene(thread, application->sceneManager, (Arcadia_Engine_Demo_Scene*)Arcadia_Engine_Demo_TextRenderingScene_create(thread, ((Arcadia_Engine_Application*)application)->engine, application->sceneManager));
