...
#include "Arcadia/Engine/Examples/FontTexture/Scene.h"
...
struct Arcadia_Engine_Demo_MainMenuScene {
  ...
  // @todo This should be inter-scene, not intra-scene.
  ...
  // The canvas size for which the model quad was last positioned.
  Arcadia_Integer32Value fontQuadCanvasWidth;
  Arcadia_Integer32Value fontQuadCanvasHeight;
};
