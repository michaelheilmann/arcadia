...
constructImpl
  (
    ...
    Arcadia_MILC_Diagnostics_SymbolIsNotDefinedDiagnostic* self
  );
...
initializeDispatchImpl
  (
    Arcadia_Thread* thread,
    Arcadia_MILC_Diagnostics_SymbolIsNotDefinedDiagnosticDispatch* self
  );
...
Arcadia_defineObjectType(u8"Arcadia.MILC.Diagnostics.SymbolIsNotDefinedDiagnostic", Arcadia_MILC_Diagnostics_SymbolIsNotDefinedDiagnostic,
...
{
  Arcadia_EnterConstructor(Arcadia_MILC_Diagnostics_SymbolIsNotDefinedDiagnostic);
  ...
  Arcadia_LeaveConstructor(Arcadia_MILC_Diagnostics_SymbolIsNotDefinedDiagnostic);
}
...
Arcadia_MILC_Diagnostics_SymbolIsNotDefinedDiagnostic*
...
{ 
  _Arcadia_BeginCreate(Arcadia_MILC_Diagnostics_SymbolIsNotDefinedDiagnostic);
  ...
  _Arcadia_EndCreate(Arcadia_MILC_Diagnostics_SymbolIsNotDefinedDiagnostic);
}
